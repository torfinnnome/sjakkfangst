...
function _tn(m,n){var s=document.createElement('span');s.className='tree-node';var ms=document.createElement('span');ms.className='tree-move';ms.textContent=m;s.appendChild(ms);var st=document.createElement('span');st.className='tree-stats';st.textContent=" "+n.games+" ("+n.wins+"W "+n.draws+"D "+n.losses+"L) ["+n.whites+"W "+n.blacks+"B]";s.appendChild(st);return s;}
